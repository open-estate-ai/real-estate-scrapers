...
@mcp.tool()
async def scrape_projects_list(max_projects: int = 50, timeout: int = 180) -> List[Dict[str, Any]]:
    """
    ...
    Returns:
        List of project dictionaries with fields: project_name, promoter_name, rera_number, 
        project_type, district, start_date, end_date, registration_date, detail_link
    """
    ...
    logger.info(
        f"✅ Completed scrape_projects_list: Returning {len(projects)} projects")
    return projects
